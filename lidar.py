...
class World(object):
    ...
    def show_data(self):
        for point in self.point_cloud:
            self.map_copy.set_at((point[0], point[1]), RED)
...
world.infomap.fill(BLACK)

lidar = Lidar(200, world.mymap)
# world.map_copy.fill(BLACK)
...
while run:
    ...
    if sensor_on:
        ...
        world.show_data()
    world.mymap.blit(world.map_copy, (0, 0))
